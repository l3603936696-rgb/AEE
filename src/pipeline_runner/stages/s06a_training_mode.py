...
def run_training_mode(
    ...
    if _training_mode:
        try:
            ...
            from src.language_system.somatic_dictionary import SOMATIC_DICTIONARY
        ...
        try:
            from src.language_system.somatic_concept_map import apply_help_delta, training_exploration_nudge
            from src.language_system.meta_cognitive import apply_meta_cognitive
