...
def run_integrity_tick(entity, tick: int) -> None:
    ...
    from src.core.integrity_monitor import scan as _integrity_scan
    from src.core.integrity_signal import update as _integrity_update
    from src.core.integrity_signal import apply_drive_bias as _integrity_apply_drive_bias
    from src.core.self_binding import record_accesses as _record_accesses
