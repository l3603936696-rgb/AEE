...
子模块：
    word_warmup_helpers.py — 解码表、rest consolidation
"""
...
# 内部 helpers
from .word_warmup_helpers import (
    _decode_state_hash,
    _build_word_profile,
    consolidate_during_rest,
    REST_CONSOLIDATION_WEIGHT,
    MAX_SYNTHETIC_PER_TICK,
    SYNTHETIC_QUENCHING_EFFICIENCY,
    MIN_REST_STRENGTH_RATIO,
)
...
__all__ = [
    "get_warm_words",
    "generate_warmup_variants",
    "inject_warmup_candidates",
    "consolidate_during_rest",
    "add_social_comprehension",
    "resonate_with_word",
]
