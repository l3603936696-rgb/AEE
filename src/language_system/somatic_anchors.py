...
Submodules of src.language_system.somatic_concept_map:
    somatic_anchors.py     — SOMATIC_ANCHORS + ANCHOR_CLUSTERS + ALL_DIMENSIONS
    somatic_concept_map.py — computation functions + public API
"""
