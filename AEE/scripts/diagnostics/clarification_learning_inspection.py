...
from AEE.src.language_system.clarification_memory import ClarificationMemory, ClarificationEpisode
from AEE.src.language_system.clarification_learning import (
...
def main():
    ...
    from AEE.src.language_system.clarification_learning import _batch_similarity, _char_overlap
    reply = "小王去北京出差了"
