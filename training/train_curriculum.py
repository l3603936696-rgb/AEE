...
from AEE.src.entity_state import EntityState, force_set_state
from AEE.src.language_training import run_language_training_tick
from AEE.src.language_system.somatic_concept_map import ANCHOR_CLUSTERS
...
def train_curriculum(rounds_per_state=5, verbose=True):
    ...
    # 热身词统计
    from AEE.src.language_system.word_warmup import get_warm_words
